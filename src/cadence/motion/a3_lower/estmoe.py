...
class A3LowerEstMoEPolicy:
    ...
    appended directly instead of the legacy 25-value context ABI. The model
    applies fixed physical input scales internally. Observation history
    always belongs to this adapter.
    """
    ...
    def __init__(self, config, services) -> None:
        ...
        self.observations = LowerVelocityHistoryObservationBuilder(
            ...
            history_frames=LOWER_VELOCITY_H32_HISTORY_FRAMES,
        )
